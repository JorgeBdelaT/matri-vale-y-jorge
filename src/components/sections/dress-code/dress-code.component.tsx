      ...
      <SectionContainer>
        <Reveal>
          ...
          <Carousel
            ...
            desktopGridClassName="grid-cols-4 gap-4 max-[860px]:grid-cols-2"
            className="mx-auto mt-12 max-w-[780px]"
            slides={DRESS_CODE.avoid.map((swatch) => (
              <div
                key={swatch.label}
                className={cn(
                  "grid min-h-[146px] grid-rows-[1fr_auto] place-items-center overflow-hidden rounded-[28px] px-3 pb-4 pt-1 shadow-[0_20px_60px_rgba(42,27,27,.13)] max-[540px]:shadow-none",
                  swatch.className
                )}
              >
                <span
